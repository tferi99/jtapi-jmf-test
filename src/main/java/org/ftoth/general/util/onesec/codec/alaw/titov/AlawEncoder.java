...
public class AlawEncoder extends com.ibm.media.codec.audio.AudioCodec
{
    ...
    public AlawEncoder()
    {
        ...
        supportedInputFormats = new AudioFormat[] {
            new AudioFormat(AudioFormat.LINEAR, Format.NOT_SPECIFIED,8,1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED),
        ...
        defaultOutputFormats = new AudioFormat[] {
            new AudioFormat(AudioFormat.ALAW,8000,8,1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED),
            new AlawAudioFormat(new AudioFormat(AlawAudioFormat.ALAW_RTP, 8000, 8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED))
        };
    }
    ...
    protected Format[] getMatchingOutputFormats(Format in)
    {
        ...
        supportedOutputFormats = new AudioFormat[] {
            new AudioFormat(AudioFormat.ALAW, sampleRate,8,1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED),
            new AlawAudioFormat(new AudioFormat(AlawAudioFormat.ALAW_RTP, sampleRate, 8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED))
        };
