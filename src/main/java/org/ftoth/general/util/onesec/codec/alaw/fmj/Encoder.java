...
public class Encoder extends AbstractCodec
{
	...
	protected Format[] outputFormats = new Format[] {new AudioFormat(AudioFormat.ALAW, -1.0, 8, 1, -1, AudioFormat.SIGNED, 8, -1.0, Format.byteArray)};
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer)
	{
        ...
        final boolean bigEndian = ((AudioFormat) inputBuffer.getFormat()).getEndian() == AudioFormat.BIG_ENDIAN;	// TODO: check for undefined
