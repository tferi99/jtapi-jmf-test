 ...
 */
package org.ftoth.general.util.onesec.codec.g729;
...
//    private static final int OUTPUT_FRAME_SIZE_IN_BYTES = 20;
    ...
    public G729Encoder()
    {
        super("G.729 Encoder", AudioFormat.class, new AudioFormat[] {
    		new AudioFormat(AudioFormat.G729, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.byteArray),
    		new G729AudioFormat(new AudioFormat(AudioFormat.G729_RTP, 8000, 8, 1))
        });
