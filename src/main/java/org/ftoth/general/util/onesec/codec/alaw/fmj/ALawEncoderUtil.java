...
//     *  @parem encoded An array to be filled with a-law bytes containing the results. must be same size as data.
//     */
...
//    }
     ...
     *  
     *  @param data An array of bytes in Little-Endian format
     *  @param target A pre-allocated array to receive the A-law bytes.  This array must be at least half the size of the source.
     */
